    ...
    return (
        ...
        <div className='About'>
                ...
                <p>Jade Day is the Vice President of A Twist of Fate-ATS; a nonprofit
                    ...
                    of the Cherokee Nation Healthcare System Rare Diseases Workgroup.
                    ...
                    Leadership award by Principal Chief of the Cherokee Nation Chuck Hoskin. 

                    She is a trained advocate and lobbyist; experienced in public policy, complex 
                    medical care, medical research, patient and disability rights. She has lobbied 
                    on all levels from tribal to federal in Washington DC. 

                    Jade is an X-linked carrier of a rare disorder called FG1 Syndrome. She is the 
                ...
                <p>Sky Collins has a passion for advocating and working to remove equity barriers in 
                    ...
                    for Oklahomans with disabilities. Sky is also a long-standing member on a rare disease non-profit Board of 
